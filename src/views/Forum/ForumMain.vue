...
.input2:focus {
  ...
  -webkit-box-shadow: 0 0 0 2px rgb(155 181 206 / 40%);
  box-shadow: 0 0 0 2px rgb(155 181 206 / 40%);
}
.input2 {
  width: 100%;
...
.topic-editor-base .topic-editor-css {
  display: -webkit-box;
  display: -ms-flexbox;
  display: flex;
...
.normal-sort:not(:first-child)::before {
  content: "";
  height: 40%;
  width: 1px;
